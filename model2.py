###############################################################################################
#
# -> Este script faz o cálculo da temperatura adiabática chama para o modelo 2 para uma dada razão de
...
from thermo_calc import thermo_calc_2
import numpy as np
import time

def model2(phi, pressure, max_it=50):
    """
    ...
    species_str_list = ["H2O", "O2", "H2", "OH", "O", "H"]
    ...
    a        = np.array([[2,1],
                        ...
                        [1,0]])
    b        = [2, 2*a_coef]
    y        = np.array(initialGuess(2, a_coef))
    #***********************************************************************************************
    ...
    for k in range(1, max_it):
        ...
        hs_dict, hf_dict, g_f_dict = thermo_calc_2(enthalpy_298_15_dict,
                                                   enthalpy_dict,
                                                   entropy_dict,
                                                   species_str_list,
                                                   T)
